            ...
            <form action="<?php echo e(route('pembayaran.store')); ?>" method="POST">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="petugas" class="form-control" id="petugas" value="<?php echo e(session('user')->nama_petugas); ?>" readonly>
                </div>
                <input type="hidden" name="id_petugas" class="form-control" id="id_petugas" value="<?php echo e(session('user')->id_petugas); ?>">
...
unset($__errorArgs, $__bag); ?>
                    <div class="alert alert-info alert-dismissible identitas mt-1">
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>" id="tanggal_bayar" placeholder="Masukkan Tanggal Bayar" value="<?php echo e(date('Y-m-d')); ?>">
...
unset($__errorArgs, $__bag); ?>
  ...
  <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp8\htdocs\templating\resources\views/pembayaran/create.blade.php ENDPATH**/ ?>